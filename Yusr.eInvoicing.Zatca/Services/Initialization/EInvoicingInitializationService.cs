...
namespace Yusr.eInvoicing.Zatca.Services.Initialization
{
    ...
    {
        public OperationResult<EInvoicePrepareDto?> Init(IEInvoiceSetting setting, IEInvoiceInvoice invoice, IEInvoiceAccount actionAccount, IEnumerable<IEInvoiceItem> dbItems, long? lastCounter, string? lastHash, bool ignoreWarnings)
        {
